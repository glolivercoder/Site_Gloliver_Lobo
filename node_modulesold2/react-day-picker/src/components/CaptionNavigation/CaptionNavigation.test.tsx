...
describe("when rendered", () => {
  ...
  test("should render the next month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="pqb8:ie" />,
      dayPickerProps,
    );
  ...
  test("should render the previous month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="1ujwqcx" />,
      dayPickerProps,
    );
  ...
  describe("when displaying the first of multiple months", () => {
    ...
    beforeEach(() => {
      customRender(
        <CaptionNavigation displayMonth={today} data-oid="6mur0uh" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying the last of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid=":ak4byp" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying a month in the middle of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid="jgx-z:z" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when clicking the previous button", () => {
    describe("and a previous month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="d0ccm93" />,
          testContext,
        );
    ...
    describe("and the previous month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="j0v9wxp" />,
          testContext,
        );
        await user.click(getPrevButton());
      });
  ...
  describe("when clicking the next month button", () => {
    describe("and the next month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="4a_zwye" />,
          testContext,
        );
    ...
    describe("and the next month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="ktjxjmg" />,
          testContext,
        );
        await user.click(getNextButton());
      });
