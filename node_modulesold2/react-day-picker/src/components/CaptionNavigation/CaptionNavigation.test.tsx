...
describe("when rendered", () => {
  ...
  test("should render the next month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="cllc3:s" />,
      dayPickerProps,
    );
  ...
  test("should render the previous month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="vhbexq." />,
      dayPickerProps,
    );
  ...
  describe("when displaying the first of multiple months", () => {
    ...
    beforeEach(() => {
      customRender(
        <CaptionNavigation displayMonth={today} data-oid="o:xbl34" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying the last of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid="zgptaqn" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying a month in the middle of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid="1hadc:0" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when clicking the previous button", () => {
    describe("and a previous month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="2tqwqs." />,
          testContext,
        );
    ...
    describe("and the previous month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="ixk_qvv" />,
          testContext,
        );
        await user.click(getPrevButton());
      });
  ...
  describe("when clicking the next month button", () => {
    describe("and the next month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="opy9ufg" />,
          testContext,
        );
    ...
    describe("and the next month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="_m7wrem" />,
          testContext,
        );
        await user.click(getNextButton());
      });
