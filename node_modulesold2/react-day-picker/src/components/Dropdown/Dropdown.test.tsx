...
function setup(props: DropdownProps, dayPickerProps?: DayPickerProps) {
  customRender(<Dropdown {...props} data-oid="1g0j766" />, dayPickerProps);
}
...
const props: Required<DropdownProps> = {
  ...
  className: "test",
  value: "bar",
  children: <option value={"bar"} data-oid="wu5-gr-" />,
  style: {},
};
...
describe("when using a custom IconDropdown component", () => {
  const components: CustomComponents = {
    IconDropdown: () => <div data-oid="dv3_vt7">Custom IconDropdown</div>,
  };
  beforeEach(() => {
