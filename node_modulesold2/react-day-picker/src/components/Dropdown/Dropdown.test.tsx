...
function setup(props: DropdownProps, dayPickerProps?: DayPickerProps) {
  customRender(<Dropdown {...props} data-oid="zeacon3" />, dayPickerProps);
}
...
const props: Required<DropdownProps> = {
  ...
  className: "test",
  value: "bar",
  children: <option value={"bar"} data-oid="gguixj0" />,
  style: {},
};
...
describe("when using a custom IconDropdown component", () => {
  const components: CustomComponents = {
    IconDropdown: () => <div data-oid="qqzf.7w">Custom IconDropdown</div>,
  };
  beforeEach(() => {
