...
function setup(props: CaptionProps, dayPickerProps?: DayPickerProps) {
  customRender(
    <CaptionDropdowns {...props} data-oid=":f3-w01" />,
    dayPickerProps,
  );
}
...
describe("when rendered with custom styles or classnames", () => {
  ...
  beforeEach(() => {
    ...
    const view = customRender(
      <CaptionDropdowns displayMonth={today} data-oid="96v1hw6" />,
      dayPickerProps,
    );
...
describe("when a month is selected", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="hsqjawf" />,
      dayPickerProps,
    );
  });
...
describe("when no date limits are set", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="4e:8rq-" />,
      dayPickerProps,
    );
  });
