...
function setup(props: CaptionProps, dayPickerProps?: DayPickerProps) {
  customRender(
    <CaptionDropdowns {...props} data-oid="-aebquq" />,
    dayPickerProps,
  );
}
...
describe("when rendered with custom styles or classnames", () => {
  ...
  beforeEach(() => {
    ...
    const view = customRender(
      <CaptionDropdowns displayMonth={today} data-oid="pvagnk_" />,
      dayPickerProps,
    );
...
describe("when a month is selected", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="k0r9x:j" />,
      dayPickerProps,
    );
  });
...
describe("when no date limits are set", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="impr2y0" />,
      dayPickerProps,
    );
  });
