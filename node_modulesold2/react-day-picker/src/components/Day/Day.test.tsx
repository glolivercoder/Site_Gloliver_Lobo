...
describe("when the day to render has an hidden modifier", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid=":gnsfst" />, dayPickerProps);
  });
...
describe('when a no selection mode and no "onDayClick"', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="db5pguu" />, dayPickerProps);
  });
...
describe("when a selection mode is set", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="yypcsq:" />, dayPickerProps);
  });
...
describe('when "onDayClick" is present', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="jgbp:a-" />, dayPickerProps);
  });
...
describe("when using a custom DayContent component", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="6xfgken" />, { components });
  });
