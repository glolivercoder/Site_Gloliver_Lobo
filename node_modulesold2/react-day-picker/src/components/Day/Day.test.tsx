...
describe("when the day to render has an hidden modifier", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="8uzp4zj" />, dayPickerProps);
  });
...
describe('when a no selection mode and no "onDayClick"', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="aovs6av" />, dayPickerProps);
  });
...
describe("when a selection mode is set", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="-39-nlm" />, dayPickerProps);
  });
...
describe('when "onDayClick" is present', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="k3bjnwe" />, dayPickerProps);
  });
...
describe("when using a custom DayContent component", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="zg:bwcb" />, { components });
  });
