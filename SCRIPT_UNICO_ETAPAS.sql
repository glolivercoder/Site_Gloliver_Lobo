-- =========================================================
-- SCRIPT EM ETAPAS PARA RESOLVER CONFLITOS DE POLÍTICAS NO SUPABASE
-- Execute cada etapa separadamente no SQL Editor do Supabase
-- =========================================================

-- ETAPA 1: REMOVER TODAS AS POLÍTICAS EXISTENTES
-- Execute esta etapa primeiro, uma de cada vez

-- Remover políticas de site_config
...
-- Remover políticas de fan_club_posts
...
-- Remover políticas de media_files
...
-- Remover políticas de featured_slots
...
-- ETAPA 2: CRIAR FUNÇÃO is_admin() PADRONIZADA
-- Execute esta etapa após a Etapa 1
...
-- ETAPA 3: CRIAR TABELAS (se não existirem)
-- Execute esta etapa após a Etapa 2
...
-- ETAPA 4: ATIVAR RLS E CRIAR POLÍTICAS PADRONIZADAS
-- Execute esta etapa após a Etapa 3
...
-- ETAPA 5: CONFIGURAR STORAGE
-- Execute esta etapa após a Etapa 4
...
-- ETAPA 6: FUNÇÕES E TRIGGERS
-- Execute esta etapa após a Etapa 5
...
-- ETAPA 7: ÍNDICES E SINCRONIZAÇÃO
-- Execute esta etapa após a Etapa 6
...
-- =========================================================
-- FIM DO SCRIPT EM ETAPAS
-- Execute cada etapa separadamente para evitar conflitos
-- =========================================================