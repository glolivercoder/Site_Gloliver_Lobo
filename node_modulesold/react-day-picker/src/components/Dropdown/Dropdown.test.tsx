...
function setup(props: DropdownProps, dayPickerProps?: DayPickerProps) {
  customRender(<Dropdown {...props} data-oid="2s7qmgs" />, dayPickerProps);
}
...
const props: Required<DropdownProps> = {
  ...
  className: "test",
  value: "bar",
  children: <option value={"bar"} data-oid="a-bamgd" />,
  style: {},
};
...
describe("when using a custom IconDropdown component", () => {
  const components: CustomComponents = {
    IconDropdown: () => <div data-oid="6o0jipx">Custom IconDropdown</div>,
  };
  beforeEach(() => {
