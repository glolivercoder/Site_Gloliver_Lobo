...
function setup(props: DropdownProps, dayPickerProps?: DayPickerProps) {
  customRender(<Dropdown {...props} data-oid="g7z6z0s" />, dayPickerProps);
}
...
const props: Required<DropdownProps> = {
  ...
  className: "test",
  value: "bar",
  children: <option value={"bar"} data-oid="68jyrf-" />,
  style: {},
};
...
describe("when using a custom IconDropdown component", () => {
  const components: CustomComponents = {
    IconDropdown: () => <div data-oid="b8jkoyh">Custom IconDropdown</div>,
  };
  beforeEach(() => {
