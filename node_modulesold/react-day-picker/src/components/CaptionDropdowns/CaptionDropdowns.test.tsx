...
function setup(props: CaptionProps, dayPickerProps?: DayPickerProps) {
  customRender(
    <CaptionDropdowns {...props} data-oid="-:2-7c3" />,
    dayPickerProps,
  );
}
...
describe("when rendered with custom styles or classnames", () => {
  ...
  beforeEach(() => {
    ...
    const view = customRender(
      <CaptionDropdowns displayMonth={today} data-oid="8gpvmx2" />,
      dayPickerProps,
    );
...
describe("when a month is selected", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="..arw98" />,
      dayPickerProps,
    );
  });
...
describe("when no date limits are set", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="5d6j2by" />,
      dayPickerProps,
    );
  });
