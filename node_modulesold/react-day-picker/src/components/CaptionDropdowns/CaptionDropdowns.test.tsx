...
function setup(props: CaptionProps, dayPickerProps?: DayPickerProps) {
  customRender(
    <CaptionDropdowns {...props} data-oid="itvl:wx" />,
    dayPickerProps,
  );
}
...
describe("when rendered with custom styles or classnames", () => {
  ...
  beforeEach(() => {
    ...
    const view = customRender(
      <CaptionDropdowns displayMonth={today} data-oid=".cqt1.l" />,
      dayPickerProps,
    );
...
describe("when a month is selected", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid="w6mixt4" />,
      dayPickerProps,
    );
  });
...
describe("when no date limits are set", () => {
  ...
  beforeEach(() => {
    customRender(
      <CaptionDropdowns displayMonth={today} data-oid=".eo7mv7" />,
      dayPickerProps,
    );
  });
