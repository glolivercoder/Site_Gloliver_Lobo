...
describe("when the day to render has an hidden modifier", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="3tz--ea" />, dayPickerProps);
  });
...
describe('when a no selection mode and no "onDayClick"', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="07vcisn" />, dayPickerProps);
  });
...
describe("when a selection mode is set", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="dx4p-m8" />, dayPickerProps);
  });
...
describe('when "onDayClick" is present', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="5ex:d1w" />, dayPickerProps);
  });
...
describe("when using a custom DayContent component", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="k9v0jz6" />, { components });
  });
