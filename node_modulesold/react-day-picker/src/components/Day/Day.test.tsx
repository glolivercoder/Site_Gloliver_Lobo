...
describe("when the day to render has an hidden modifier", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="4.7qmsx" />, dayPickerProps);
  });
...
describe('when a no selection mode and no "onDayClick"', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="a:jns_q" />, dayPickerProps);
  });
...
describe("when a selection mode is set", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="_wsj6kx" />, dayPickerProps);
  });
...
describe('when "onDayClick" is present', () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="fz6m28_" />, dayPickerProps);
  });
...
describe("when using a custom DayContent component", () => {
  ...
  beforeEach(() => {
    customRender(<Day {...props} data-oid="xsz8:-i" />, { components });
  });
