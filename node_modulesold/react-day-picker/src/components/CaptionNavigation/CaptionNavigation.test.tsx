...
describe("when rendered", () => {
  ...
  test("should render the next month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="78xbxv4" />,
      dayPickerProps,
    );
  ...
  test("should render the previous month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="k8n:0:h" />,
      dayPickerProps,
    );
  ...
  describe("when displaying the first of multiple months", () => {
    ...
    beforeEach(() => {
      customRender(
        <CaptionNavigation displayMonth={today} data-oid="37rw7sr" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying the last of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid="w1z3c1-" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying a month in the middle of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid="r4azjra" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when clicking the previous button", () => {
    describe("and a previous month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="r6mst2f" />,
          testContext,
        );
    ...
    describe("and the previous month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="psts81t" />,
          testContext,
        );
        await user.click(getPrevButton());
      });
  ...
  describe("when clicking the next month button", () => {
    describe("and the next month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="h7oqvo6" />,
          testContext,
        );
    ...
    describe("and the next month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="bbfc9zo" />,
          testContext,
        );
        await user.click(getNextButton());
      });
