...
describe("when rendered", () => {
  ...
  test("should render the next month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="nbz1zkr" />,
      dayPickerProps,
    );
  ...
  test("should render the previous month button", () => {
    customRender(
      <CaptionNavigation displayMonth={today} data-oid="m0q0l0d" />,
      dayPickerProps,
    );
  ...
  describe("when displaying the first of multiple months", () => {
    ...
    beforeEach(() => {
      customRender(
        <CaptionNavigation displayMonth={today} data-oid="xo.yje_" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying the last of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid=":q1bpep" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when displaying a month in the middle of multiple months", () => {
    ...
    beforeEach(() => {
      ...
      customRender(
        <CaptionNavigation displayMonth={lastMonth} data-oid="iinccem" />,
        {
          ...dayPickerProps,
          numberOfMonths,
        },
  ...
  describe("when clicking the previous button", () => {
    describe("and a previous month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="cmneuuo" />,
          testContext,
        );
    ...
    describe("and the previous month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="u:-ql-d" />,
          testContext,
        );
        await user.click(getPrevButton());
      });
  ...
  describe("when clicking the next month button", () => {
    describe("and the next month is defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="5hlt-x8" />,
          testContext,
        );
    ...
    describe("and the next month is not defined", () => {
      ...
      beforeEach(async () => {
        customRender(
          <CaptionNavigation displayMonth={today} data-oid="eqftkgn" />,
          testContext,
        );
        await user.click(getNextButton());
      });
